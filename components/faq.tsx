...
const faqItems = [
  {
    ...
    answer: "Сервер активируется автоматически после оплаты. Вы получите доступ к панели управления в течение нескольких секунд."
  },
  {
    icon: CreditCard,
    question: "Какие способы оплаты вы принимаете?",
    answer: "Мы принимаем банковские карты и криптовалюту. Все платежи обрабатываются через защищённые платёжные системы."
  },
  {
    icon: Shield,
    question: "Есть ли защита от DDoS-атак?",
    answer: "Да, все наши серверы защищены от DDoS-атак. Защита включена бесплатно во все тарифы и фильтрует вредоносный трафик автоматически."
  },
  {
    icon: ArrowUpDown,
  ...
  },
  {
    ...
    answer: "Наша поддержка работает 24/7 через тикет-систему и Discord. Среднее время ответа — 8 часов. Мы помогаем с настройкой серверов и решением технических проблем."
  },
  {
    icon: Database,
    question: "Делаете ли вы бэкапы?",
    answer: "Автоматические бэкапы мы не делаем. Вы можете создавать бэкапы вручную или добавить задачу через панель управления. Рекомендуем регулярно сохранять важные данные самостоятельно."
  },
]
