      ...
      try {
        ...
        await sendEmail({
          ...
          html: `
            ...
            <p>Вы можете управлять StorageBox в личном кабинете: <a href="${process.env.NEXT_PUBLIC_URL || 'https://saintproject.xyz'}/client/servers">Перейти в панель</a></p>
            
            <p>С уважением,<br>Команда SaintProject</p>
          `,
        })
      } catch (emailError) {
